...
CREATE TABLE `prediction` (
  ...
  `predictioncol` varchar(45) DEFAULT NULL,
...
CREATE TABLE `question` (
  ...
  `answerOK` int(11) DEFAULT NULL COMMENT 'indice entre answer 1 y 5',
  `match` int(11) DEFAULT NULL,
  PRIMARY KEY (`idQuestion`),
  KEY `match_FK_idx` (`match`),
  CONSTRAINT `match_FK` FOREIGN KEY (`match`) REFERENCES `match` (`idMatch`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-07-16 16:48:30
