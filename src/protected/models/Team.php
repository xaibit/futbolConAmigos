...
class Team extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idTeam, name, image', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'matchesLocal' => array(self::HAS_MANY, 'Match', 'localTeam'),
			'matchesVisitant' => array(self::HAS_MANY, 'Match', 'visitantTeam'),
			'players' => array(self::HAS_MANY, 'Player', 'team'),
		);
	}
