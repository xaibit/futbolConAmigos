...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="btn-group btn-group-justified" data-toggle="buttons">
		...
		<label class="btn btn-default <?php echo ($model->answer4 == 1) ? 'active' : ''; ?>">
			<?php 
				$option43 = ($model->ques4 != null) ? $model->ques4->answer3 : 'Opcion 3';
				echo $form->radioButton($model,'answer4', array('value'=>1, 'uncheckValue'=>null)) . $option43; 
			?>
		</label>		
		<label class="btn btn-default <?php echo ($model->answer4 == 1) ? 'active' : ''; ?>">
			<?php 
				$option44 = ($model->ques4 != null) ? $model->ques4->answer4 : 'Opcion 4';
				echo $form->radioButton($model,'answer4', array('value'=>1, 'uncheckValue'=>null)) . $option44; 
			?>
		</label>			
